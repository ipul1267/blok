...
<body>
	<h1>Selamat Ulang Tahun sipaa</h2>
...
<html>
	<head>
		<body>
			...
			<br><font size="3px">
			<font color="white">[ </font><marquee scrollamount="5" width="630" height="20" behavior="alternate">Selamat ulang tahun sipa. Semoga panjang umur, murah rejeki, dan sehat selalu. Ingat selalu pesan gw! lupain fikri esa randit ama semua yg bikin lu sedih !</marquee><font color="white"> ]</font>
...
<body>
	<h1>Selamat Ulang Tahun sipa</h2>
   <script>var rnd = Math.random, flr = Math.floor;
   let canvas = document.createElement('canvas');
...
<html>
	<head>
		<body>
			...
			<font face="Abel" size="6px" color="grey"><b></b>
			<br><font size="3px">
			<font color="white">[ </font><marquee scrollamount="5" width="630" height="20" behavior="alternate">Selamat ulang tahun sipaaa. Semoga panjang umur, murah rejeki, dan sehat selalu. Ingat selalu pesan gw! lupain fikri esa randit ama semua yg bikin lu sedih!</marquee><font color="white"> ]</font>
			<br><br><font size="3px" face="Ubuntu Condensed">
		</body>
	</font>
